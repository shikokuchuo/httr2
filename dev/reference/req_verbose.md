...
#> <- accept-ranges: bytes
#> <- date: Mon, 22 Dec 2025 14:14:41 GMT
#> <- via: 1.1 varnish
#> <- age: 16
#> <- x-served-by: cache-sjc1000127-SJC
#> <- x-cache: HIT
#> <- x-cache-hits: 1
#> <- x-timer: S1766412882.506566,VS0,VE1
#> <- vary: Accept-Encoding
#> <- x-fastly-request-id: d69b4e0c5ee5cfddc41ce8e3153cd2196a99346d
#> <- content-length: 4833
#> <- 
...
#> <- x-cache: HIT
#> <- x-cache-hits: 2
#> <- x-timer: S1766412882.524083,VS0,VE0
#> <- vary: Accept-Encoding
#> <- x-fastly-request-id: caa64559c322d986dee84d57ef600ca2a112a072
#> <- content-length: 4833
#> <- 
```
