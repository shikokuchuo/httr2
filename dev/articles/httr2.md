...
#> accept-encoding: deflate, gzip, br, zstd
#> content-length: 246
#> content-type: multipart/form-data; boundary=------------------------Ovkas2U25NuF66sqwqbdZv
#> host: 127.0.0.1:44917
#> user-agent: httr2/1.2.2.9000 r-curl/7.1.0 libcurl/8.5.0
#> 
#> --------------------------Ovkas2U25NuF66sqwqbdZv
...
resp |> resp_raw()
#> HTTP/1.1 200 OK
#> Date: Mon, 15 Jun 2026 08:47:38 GMT
#> Content-Type: application/json
#> Content-Length: 407
#> ETag: "de760e6d"
#> 
